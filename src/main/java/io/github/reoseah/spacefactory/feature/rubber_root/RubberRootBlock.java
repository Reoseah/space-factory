package io.github.reoseah.spacefactory.feature.rubber_root;
...
public class RubberRootBlock extends CropBlock {
    ...
    public RubberRootBlock(AbstractBlock.Settings settings) {
        super(settings);
    }
    ...
    protected ItemConvertible getSeedsItem() {
        return SpaceFactory.Items.RUBBER_ROOT_SEEDS;
    }
